    ...
    return (
        <div className="w-full col-span-1">
            <div className="bg-white rounded-xl shadow p-6 flex flex-col gap-4">
                ...
                <Button className="w-full bg-primary-light hover:bg-primary-light/90 text-base font-semibold !rounded-full py-4 text-black cursor-pointer" onClick={() => setOpen(true)}>Join event</Button>
