    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-primary rounded-xl p-6">
                <h3 className="text-base font-semibold text-white mb-2">Refund & cancellation policy</h3>
                <ul className="text-sm text-white space-y-1">
                ...
                <a href="#" className="text-white text-sm font-medium hover:underline mt-2 inline-block">Learn more</a>
            </div>
        </section>
    );
}